...
const Navbar = () => {
    ...
    return (
        <>
            <nav className={`relative z-20 w-full md:static md:text-sm md:border-none ${state ? "shadow-lg rounded-b-xl md:shadow-none" : ""}`}>
                <div className="items-center gap-x-14 px-4 md:flex md:px-8 md:justify-between">
                                        ...
                                        <li key={idx}>
                                            ...
                                            }
                                            {
                                                item.isDrapdown && drapdownState.idx == idx && drapdownState.isActive ? (
                                                    <div className="mt-6 inset-x-0 top-20 w-1/2 md:absolute md:border-y md:shadow-md md:mt-0">
                    ...
                    <div className='items-center justify-end gap-x-6 space-y-3 md:flex md:space-y-0'>
                            <a href="javascript:void(0)" className="block py-3 px-4 font-medium text-center text-white bg-blue-500 hover:bg-indigo-500 active:bg-indigo-700 active:shadow-none rounded-lg shadow md:inline">
                                Sign in
                            </a>
                    </div>
                </div>
