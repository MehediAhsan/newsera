...
const Navbar = () => {
    const dropdownNavs = [
        ...
        {
            title: "Concrete Repair & Chemical Application",
            path: "concrete-and-chemical",
            icon: ''
        },
        {
            title: "Construction Chemical Supply",
            path: "/construction-chemical-supply",
            icon: ''
        },
        {
            title: "Rebar Coupler",
    ...
    const navigation = [
        ...
        { title: "Services", path: "javascript:void(0)", isDrapdown: true, navs: dropdownNavs },
                    ...
                    <div className={`nav-menu text-white uppercase pb-3 mt-8 md:block text-start w-full md:w-auto md:pb-0 md:mt-0 ${state ? 'block' : 'hidden'}`}>
                        <ul className="items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
                                        ...
                                        <li key={idx}>
                                            {
                                                item.isDrapdown ? (
                                                    ...
                                                    <Link href={item.path} className="block text-sm p-3 hover:text-green-600 rounded">
                                                        {item.title}
                                                    </Link>
                                                )
                                            }
                                            {
                                                item.isDrapdown && drapdownState.idx == idx && drapdownState.isActive ? (
                                                    <div className="mt-6 top-[68px] z-50 md:right-20 lg:right-20 md:absolute  md:border-x md:border-primary md:shadow-md md:mt-0 w-auto md:w-[450px] lg:w-[600px] ">
                            ...
                            {/* <div className='flex-1 items-center justify-end gap-x-6 space-y-3 md:flex md:space-y-0'>
                                <li>
                                    <a href="javascript:void(0)" className="block py-3 text-center text-gray-700 hover:text-green-600 border rounded-lg md:border-none">
                                        Log in
                                    </a>
                                </li>
                                <li>
