...
const TrendingNewsCard = ({ rating = null, img }) => {
    ...
    return (
        <div onMouseEnter={() => setIsHover(true)} onMouseLeave={() => setIsHover(false)} className='bg-sixth text-center text-secondary relative p-3'>
            <div className=' z-[15] hover:cursor-pointer'>
                ...
                <Image src={img ? img : "https://images.unsplash.com/photo-1579065560489-989b0cc394ce?q=80&w=1905&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"} alt='' height={400} width={200} className='object-cover w-full h-28 mx-auto'></Image>
            </div>
            <div className='mt-3'>
                <Link href='#' className='news-name'>News Name</Link>
                <p className='text-xs'>October 12, 2025</p>
            </div>
        </div>
    );
};
