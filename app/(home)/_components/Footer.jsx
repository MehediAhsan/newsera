...
const Footer = () => {
    ...
    return (
        <div className='pt-10 px-10'>
            ...
            <p className='text-fifth dark:text-third text-center text-sm italic py-3'>© NewEra. All Rights Reserved. Design by <a href="https://mehediahsan.vercel.app/" className='text-dark dark:text-light'>Mehedi Ahsan</a></p>
        </div>
    );
};
